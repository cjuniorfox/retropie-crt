...
ntsc_snes(){
	vcgencmd hdmi_timings 1084 0 32 96 96 240 0 2 2 17 0 0 2 60.100 0 20600000 1 && tvservice -e DMT\ 88 && tvservice -e DMT\ 87 && sleep 0.5 && fbset -xres 542 -yres 240 -depth 32
}
ntsc_pcengine(){
