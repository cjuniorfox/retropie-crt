...
ntsc_megadrive(){
	vcgencmd hdmi_timings 1432 0 42 127 127 240 0 2 2 17 0 0 1 59.920 0 27100000 1 && tvservice -e DMT\ 88 && tvservice -e DMT\ 87 && sleep 0.5 && fbset -xres 1432 -yres 240 -depth 32
}
ntsc_mastersystem(){
