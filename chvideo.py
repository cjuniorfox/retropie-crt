...
parser.add_argument("--progressive","-p", help="Progressive 240p/288p",default=False)
parser.add_argument("--pal","-P", help="PAL format", default=False)
...
parser.add_argument("--verbose","-v",help="Print defailed data", default=False)
parser.add_argument("--info","-i",help="Only print without applyng any change",default=False)
