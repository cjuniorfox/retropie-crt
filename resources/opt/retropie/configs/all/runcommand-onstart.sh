...
ntsc_megadrive(){
	vcgencmd hdmi_timings 1044 0 31 93 93 240 0 2 2 17 0 0 3 59.920 0 19800000 1 && tvservice -e DMT\ 88 && tvservice -e DMT\ 87 && sleep 0.5 && fbset -xres 348 -yres 240 -depth 32
}
ntsc_mastersystem(){
