...
ntsc_megadrive(){
	vcgencmd hdmi_timings 1392 0 41 124 124 240 0 2 2 17 0 0 4 59.920 0 26400000 1 && tvservice -e DMT\ 88 && tvservice -e DMT\ 87 && sleep 0.5 && fbset -xres 348 -yres 240 -depth 32
}
ntsc_mastersystem(){
...
ntsc_arcade(){
	vcgencmd hdmi_timings 1920 0 109 180 230 240 0 2 2 17 0 0 1 59.940 0 38300000 1 && tvservice -e DMT\ 88 && tvservice -e DMT\ 87 && sleep 0.5 && fbset -xres 1920 -yres 240 -depth 32
}
