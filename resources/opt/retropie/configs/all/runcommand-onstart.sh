...
ntsc_arcade(){
	vcgencmd hdmi_timings 1920 0 57 175 225 240 0 2 2 17 0 0 1 59.940 0 37300000 1 && tvservice -e DMT\ 88 && tvservice -e DMT\ 87 && sleep 0.5 && fbset -xres 1920 -yres 240 -depth 32
}
