...
ntsc_neogeo(){
	vcgencmd hdmi_timings 1392 0 41 124 124 224 0 10 10 17 0 0 4 59.185 0 26100000 1 && tvservice -e DMT\ 88 && tvservice -e DMT\ 87 && sleep 0.5 && fbset -xres 348 -yres 224 -depth 32
}
ntsc_nes(){
