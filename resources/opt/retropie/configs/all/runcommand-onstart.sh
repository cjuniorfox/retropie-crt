...
ntsc_megadrive(){
	vcgencmd hdmi_timings 960 0 49 89 109 240 0 2 2 17 0 0 1 59.920 0 19000000 1 && tvservice -e DMT\ 88 && tvservice -e DMT\ 87 && sleep 0.5 && fbset -xres 960 -yres 240 -depth 32
}
ntsc_mastersystem(){
