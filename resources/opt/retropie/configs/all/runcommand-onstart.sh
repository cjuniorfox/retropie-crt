...
ntsc_megadrive(){
	vcgencmd hdmi_timings 1408 0 41 125 125 240 0 2 2 17 0 0 1 59.920 0 26700000 1 && tvservice -e DMT\ 88 && tvservice -e DMT\ 87 && sleep 0.5 && fbset -xres 1408 -yres 240 -depth 32
}
ntsc_mastersystem(){
